...
// Screenshots are the real app at 1440px (public/screenshots/*.png); retake them when a home screen changes.
...
const STEPS = [
  { who: "Team member", title: "Raise it in one box.",
    ...
    shot: "/screenshots/raise-box.png", w: 1600, h: 900,
  ...
  { who: "Team leader", title: "Answer in one click.",
    ...
    shot: "/screenshots/leader.png", w: 2880, h: 1400,
  ...
  { who: "Everyone", title: "See what is waiting on whom.",
    ...
    shot: "/screenshots/dashboard.png", w: 2880, h: 1400,
